    ...
    <div class="max-w-6xl mx-auto p-4 pb-24 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            {#each activeTab === "main" ? data.leads.main : data.leads.call as lead (lead.id)}
                <!-- DISPLAY CARD -->
                <div
                    class="relative overflow-hidden group border-4 border-black rounded-2xl p-5 bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:translate-x-1 transition-all flex flex-col h-full"
                >
                    {#if submittingId === lead.id}
                        <div
                            class="absolute inset-0 bg-white/60 backdrop-blur-[2px] z-30 flex flex-col items-center justify-center"
                        >
                            <div
                        ...
                        <div class="flex items-start gap-2">
                            <h2 class="text-2xl font-bold leading-tight">
                                <a
                                    ...
                                    class="hover:text-blue-600 transition-colors {lead.website &&
                                    lead.website.toLowerCase() !== 'view' &&
                        ...
                        {#if lead.stage === "main"}
                            ...
                            <div class="relative">
                                ...
                                {#if openDropdown === lead.id}
                                    <div
                                        class="absolute z-20 right-0 mt-2 w-36 bg-white border-4 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden flex flex-col"
                                    >
                    ...
                    {#if lead.revenue}
                        <div
                            class="bg-green-50 border-2 border-green-800 border-dashed rounded-lg p-3 mb-4 text-sm font-black whitespace-pre-wrap text-green-900 flex items-center justify-between"
                        >
                    ...
                    {#if lead.remarks}
                        <div
                            class="bg-gray-50 border-2 border-black border-dashed rounded-lg p-3 mb-4 text-sm font-medium whitespace-pre-wrap"
                        >
                            <span
                                class="text-gray-500 uppercase text-xs font-bold block mb-1"
                                >Remarks / Needs</span
                            >{lead.remarks}
                        </div>
                    {/if}
                ...
                >
                    <div>
                        ...
                        <input
                            ...
                            placeholder="E.g., Supermarket Name"
                        />
                    </div>
                    <div>
        ...
        >
            ...
            >
                ...
                <p class="font-bold mb-6 text-gray-600">
                    Enter revenue for {revenueModalLead.business}
                </p>
